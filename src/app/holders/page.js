...
const TablePage = () => {
  const [tableData, setTableData] = useState([
    {
      owner: "0x7285e8f0186a0a41e73cef7603ad7b80a2d5a793",
      held: "7285e…5a793",
      percentageHeld: "4.5%",
    },
    {
      owner: "0xaaa2da255df9ee74c7075bcb6d81f97940908a5d",
      held: "aaa2d…08a5d",
      percentageHeld: "2.7%",
    },
    {
    ...
    {
      owner: "0x020ca66c30bec2c4fe3861a94e4db4a498a35872",
      held: "020ca…35872",
      percentageHeld: "1.4%",
    },
    {
      owner: "0x08c1ae7e46d4a13b766566033b5c47c735e19f6f",
      held: "08c1a…19f6f",
      percentageHeld: "0.9%",
    },
    {
      owner: "0x98e711f31e49c2e50c1a290b6f2b1e493e43ea76",
      held: "98e71…3ea76",
      percentageHeld: "0.8%",
    },
  ]);
          ...
          <tbody>
            {tableData.map((row, index) => (
              <tr key={index}>
                <td>{row.owner}</td>
                <td>{row.held}</td>
                <td>{row.percentageHeld}</td>
                <td>
                  {/* <img src="https://etherscan.io/address/0x7285e8f0186a0a41e73cef7603ad7b80a2d5a793" /> */}
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
